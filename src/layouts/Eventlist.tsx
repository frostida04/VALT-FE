    ...
    return(
        <div className="w-full flex flex-col text-[#777E90] lg:px-40 md:px-[39px] my-2">
            <div className="w-full flex py-4">
                <div className="flex flex-row w-full bg-darkgrayBackgroundColor md:rounded-full lg:rounded-full py-3 pl-[65px] pr-2 justify-between">
                    ...
                    <button className="flex-none w-10 h-10 px-auto items-center py-auto rounded-full ring-2 ring-outset ring-current">
